...
class orderController extends Controller
{
    ...
    {
        $orders = orderItem::where('status', '>', 7)->join('orders', 'orders.id', '=', 'order_items.order_id')->where('order_items.user_id', auth()->user()->id)->where('order_items.verified', 1)->orderBy('id', 'desc');
