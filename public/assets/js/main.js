...
$("body").on('change', "input[name=product]", function () {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            result += "</div>";
            result += "<div class='col-md-6 speed'><h3>سرعت چاپ</h3>" + "<input type='radio' name='speed' id='normal' class='input-hidden' value='normal' /><label for='normal'><img src='/assets/img/normal.jpg' /></label>";
