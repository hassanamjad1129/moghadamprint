...
<div class="container" style="padding: 0;">
    ...
    <div class="container" style="padding: 0;">
        ...
        <div style = "width : 100%; display : flex ; flex-direction: column; justify-content : center ; align-items : center; padding-top : 2rem ; padding-bottom : 2rem" class = "myPricesListImage">
          <img style = "width : 90%; border : 2px solid #ccc;" src="/assets/img/newHeader.png" alt="">
          <img style = "width : 90%; border : 2px solid #ccc; margin-top : 3rem;" src="/assets/img/newHeader80.png" alt="">
        </div>
