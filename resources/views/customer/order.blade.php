    ...
    <div>
      <div id="step-1" class="">
        <div class="wizardMultiImageSection">
          ...
          <div class="wizardImageItem" catId="{{ $category->id }}" onclick="categorySelectHandler(this)">
        ...
        <h3 style="text-align:center">خدمات پس از چاپ</h3>
          ...
          <table class="table table-striped table-bordered table-hover" style="width:100%">
            ...
            <tbody>
              ...
              <tr>
                <td><div class="form-check"><label class="toggle"><input type="checkbox" style="display:none" name="services[]" value="5"><span class="label-text" style="font-size:31px"></span></label></div></td>
                <td>{{ $service->name }}</td>
                <td>{{ $service->single_price }} ریال </td>
                <td><textarea class="form-control" name="description-{{ $service->id }}" id="" cols="30" rows="2"></textarea></td>  
              </tr>
              @endforeach
            </tbody>
          </table>
    ...
    <div class="modal-dialog modal-lg" style="width: 95%">
      <div class="modal-content">
        <div class="modal-heading">
          <i class="ion-close-circled text-danger" style="font-size: 45px;margin-right: 1rem;cursor: pointer" onclick="closeResultModal()"></i>
