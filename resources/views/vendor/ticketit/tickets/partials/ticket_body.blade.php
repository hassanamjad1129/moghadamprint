                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        <div class="col-md-6">
                            ...
                            <p>
                                ...
                                @if( $ticket->isComplete() && ! $setting->grab('default_close_status_id') )
                                    <span style="color: blue">بسته شده</span>
                                @else
                        ...
                        <div class="col-md-6">
                            ...
                            <p>
                                <strong>{{ trans('ticketit::lang.created') }}</strong>{{ trans('ticketit::lang.colon') }}{{ jdate(strtotime($ticket->created_at))->ago() }}
                            </p>
                            <p>
                                <strong>{{ trans('ticketit::lang.last-update') }}</strong>{{ trans('ticketit::lang.colon') }}{{ jdate(strtotime($ticket->updated_at))->ago() }}
                            </p>
                        </div>
                    </div>
                </div>
